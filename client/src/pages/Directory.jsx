...
const Directory = () => {
  ...
  // Read URL parameters and fetch alumni accordingly
  useEffect(() => {
  ...
  const sendEmail = () => {
    console.log("Selected Alumni:", selectedAlumni); // Debugging log
      ...
      <div className="flex">
        ...
        <div className="flex flex-col flex-1 p-5 bg-gray-100 rounded-lg">
          ...
          <form onSubmit={handleSearchSubmit}>
            ...
            <input type="text" id="branch" placeholder="Branch" value={searchQuery.branch} onChange={handleSearchChange} className="border p-3 rounded-lg mt-4 w-full" />
